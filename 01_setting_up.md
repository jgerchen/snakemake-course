...
+ **Environments** Environments are collections of software, that run a specific, isolated shell environment. This means that you can have different conda environments running at the same time if you open multiple shells.
