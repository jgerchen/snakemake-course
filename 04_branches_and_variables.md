...
+ The SLiM script, which defines how our slimulation runs. This time it will output a vcf file called **04_slim_output.vcf**. You can use the same conda environment for Slim as last time
